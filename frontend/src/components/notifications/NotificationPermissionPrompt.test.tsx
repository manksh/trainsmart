...
describe('NotificationPermissionPrompt', () => {
  ...
  describe('edge cases', () => {
    ...
    it('calls callback on each click when clicking multiple times', () => {
      render(<NotificationPermissionPrompt {...defaultProps} />)
      ...
      // Each click triggers the callback (component doesn't debounce)
      expect(mockOnEnable).toHaveBeenCalledTimes(2)
    })
  })
